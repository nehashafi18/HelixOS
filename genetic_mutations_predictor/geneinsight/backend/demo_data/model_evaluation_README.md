# Model Evaluation Set — HelixOS Demo Dataset
...
| Field | Value |
|-------|-------|
| Dataset Name | Model Evaluation Set |
| Variants | 1000 |
| Format | CSV |
| Categories | ML Evaluation, Benchmarking |
| Genes | BRCA1, BRCA2, TP53, ATM, PALB2, CHEK2, MLH1, MSH2... |

## Purpose

Balanced 1,000-variant dataset for ML model benchmarking (50% pathogenic / 50% benign)
