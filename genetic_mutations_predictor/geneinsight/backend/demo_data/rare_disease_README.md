# Rare Disease Panel — HelixOS Demo Dataset
...
| Field | Value |
|-------|-------|
| Dataset Name | Rare Disease Panel |
| Variants | 100 |
| Format | CSV |
| Categories | Rare Disease, Pediatric Genetics |
| Genes | CFTR, DMD, SCN1A, MECP2, FBN1, COL1A1, KCNQ1 |

## Purpose

Synthetic pediatric and rare disease genetics panel
